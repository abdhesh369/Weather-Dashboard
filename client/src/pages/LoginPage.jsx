  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        onFocus={e => { e.target.style.background = 'rgba(255,255,255,0.10)'; e.target.style.borderColor = 'var(--brand-primary)'; e.target.style.boxShadow = '0 0 0 3px rgba(99,102,241,0.15)'; }}
