...
export default function DemoOne() {
  return (
    <div
      className='p-8 w-full gap-8 py-16 rounded-xl min-h-screen flex items-center justify-center'
      style={{
        background:
          'url("https://images.unsplash.com/photo-1590867286251-8e26d9f255c0?q=80&w=1687&auto=format&fit=crop") center / cover no-repeat',
      }}
    >
      <div className='grid w-full max-w-xl grid-cols-2 gap-4 mx-auto'>
        ...
        <LiquidGlassCard
          ...
          borderRadius='8px'
          glowIntensity='none'
          className='rounded-3xl p-6 text-white bg-white/10 flex flex-col items-start justify-center'
        >
